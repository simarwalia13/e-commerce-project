 ...
 return  product?.productId === "Rug2"
  ...
  return (
    <div>
      ...
      <div 
      className="h-[100vh] w-fit top-1/3 absolute left-1/3">
      ...
      <div className="w-full mt-[-65px] absolute">
       ...
       <svg   preserveAspectRatio="xMidYMid meet" data-bbox="34 52 132 96" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="34 52 132 96" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-k2eflne6 svg [data-color="1"] </style></defs>
        <g>
      ...
      Furniture
       ...
       <div className="flex justify-center items-center border-r-[1px] border-b-[1px] border-black gap-x-2 py-[50px] bg-white  w-full">
       <svg preserveAspectRatio="xMidYMid meet" data-bbox="58.063 53.195 83.873 93.609" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="58.063 53.195 83.873 93.609" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-k2efqkxy svg [data-color="1"] </style></defs>
    <g>
      ...
      <button className="  text-xl  text-black  ">
       ...
       <div className="flex justify-center items-center border-r-[1px] border-b-[1px] border-black gap-x-2 py-[50px] bg-white  w-full">
       <svg preserveAspectRatio="xMidYMid meet" data-bbox="24.75 48.75 150.5 102.499" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="24.75 48.75 150.5 102.499" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-k2efs9ne svg [data-color="1"] </style></defs>
    <g>
      ...
      Rugs
       ...
       <svg preserveAspectRatio="xMidYMid meet" data-bbox="65.1 45.6 69.8 108.8" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="65.1 45.6 69.8 108.8" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-k35z35qg svg [data-color="1"] </style></defs>
    <g>
   ...
   <div className="  mt-[35px] flex">
    ...
    >
        <div className="text-3xl mb-3 " data-aos = "fade-right">Cozy Sophistication</div>
        <p className="" data-aos = "fade-right">I'm a paragraph. Click here to add your own text and</p>
        <p className="mb-5" data-aos = "fade-right">edit me. Let your users get to know you.</p>
        <div className="text-lg  bg-[#35373C]  w-fit  bg-black px-[20px] py-2 text-white cursor-pointer hover:bg-white hover:text-black hover:border hover:border-black" data-aos = "fade-right">
            Shop Furniture
          </div>
          {getFurnitureImage?.map((product)=>(<img 
...
<div className="w-[50%] flex flex-col items-center">
    ...
    alt="" />
    <div className="w-[40%] text-3xl text-center mt-[20px] mb-[20px]">House Visit: Jane Levi's
Californian Oasis</div>
<p className="w-[40%] text-center mb-[20px]" data-aos = "fade-right">I'm a paragraph. Click here to add your own text and edit me. Let your users get to know you.</p>
<div className="text-lg  bg-[#35373C]  w-fit  bg-black px-[20px] py-2 text-white cursor-pointer hover:bg-white hover:text-black hover:border hover:border-black"  data-aos = "fade-up"
...
<div className="mb-[80px]">
   <div className="flex justify-center ">
    <div className="border border-black text-4xl w-fit px-[130px] py-[15px] tracking-[0.10em] z-10 bg-white absolute ">Brands & Designers</div>
   </div>
   <div className=" w-full flex justify-center ">
   {brandImages?.map((images,index)=>(<img  className="border border-black w-[19%] mt-[30px] flex justify-center items-center px-[130px] py-[90px]"
   key={index} data-aos = "fade-right" src= {images} alt= {`images ${index}`} />))}
   </div>
   </div>
...
<div className="text-3xl text-black tracking-[.10em]">#AfternoonAtHome</div>
</div>
  <div className="">
